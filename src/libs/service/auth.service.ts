...
export class authService {
    ...
    async registerBusiness({name, address, email, service, description, nit, img, password}: registerBusinessDto){
    ...
    async registerUser({userId, name, age, cellphone, email, password}: registerUserDto){
